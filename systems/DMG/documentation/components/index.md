...
## A full table of every DMG component and their part numbers/specification.

<input type="text" id="DMGInput" onkeyup="searchFunction()" placeholder="Search for Component/Part Number/Specification">
